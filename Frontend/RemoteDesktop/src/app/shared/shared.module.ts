...
@NgModule({
  declarations: [
    ...
    BuildingsSmartTableComponent,
    NumberInputEditorComponent,
    StateButtonInputEditorComponent,
    AddFieldsButtonEditorComponent,
    LogsButtonInputEditorComponent,
    ConnectButtonInputEditorComponent],
